...
# --- Comprehensive Slang and Contraction Dictionaries from the team's notebooks ---
SLANG_MAP = {
    ...
    r'\bgr8\b': 'great', r'\bngl\b': 'not going to lie', r'\blmk\b': 'let me know',
    r'\bnp\b': 'no problem', r'\bsup\b': 'what is up', r'\bwbu\b': 'what about you'
}
...
nb = {
 "cells": [
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {},
   "source": ["## PART 1: GLOBAL SETUP & IMPORTS"]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {},
   "source": ["## PART 2: DATA LOADING & SURGICAL CLEANING (TEAM BEST PRACTICES)"]
  },
  {
   "cell_type": "code",
   "execution_count": None,
   ...
   "source": [
    ...
    "    for c, e in " + str(CONTRACTIONS) + ".items():\n",
    "        text = text.replace(c, e)\n",
    "        \n",
    "    # 2. Slang Mapping (Julianah/Ivy)\n",
    "    for s, c in " + str(SLANG_MAP) + ".items():\n",
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {},
   "source": ["## PART 3: FEATURE ENGINEERING (TF-IDF & GLOVE)"]
  },
  {
   "cell_type": "code",
   "execution_count": None,
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {},
   "source": ["## PART 4: TRAINING ALL 10 BASE MODELS (EXPLICIT)"]
  },
  {
   "cell_type": "code",
   "execution_count": None,
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {},
   "source": ["## PART 5: GENERATING PROBABILITIES"]
  },
  {
   "cell_type": "code",
   "execution_count": None,
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {},
   "source": ["## PART 6: THE META-LEARNER (XGBOOST - THE 11TH MODEL)"]
  },
  {
   "cell_type": "code",
   "execution_count": None,
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {},
   "source": ["## PART 7: FINAL REPORT & VISUALS"]
  },
  {
   "cell_type": "code",
   "execution_count": None,
...
with open('FINAL_SENTIMENT_ANALYSIS_STACKING.ipynb', 'w') as f:
